		...
		<section class="panel">
			...
			<div class="panel-body">
				<div class="btn-group btn-group-lg">
                    <button class="btn btn-default examine-state" type="button" onclick="getBorrow('1',this)">审核中</button>
                    <button class="btn btn-default btn-info examine-state" type="button" onclick="getBorrow('2',this)">审核完毕</button>
                </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var url = "${pageContext.request.contextPath}/data/all?borrowType="+$("#borrowType").val();
