...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			jqFilter.bind( 'keyup.DT', function(e) {
				...
				/* Now do the filter */
				if ( (val != oPreviousSearch.sSearch && e.keyCode == 13) || (e.keyCode == 8 && (this.value.length == 0)))
				{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "显示第  _START_ 条 ~ 第  _END_ 条记录，共  _TOTAL_ 条记录",
