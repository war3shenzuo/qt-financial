      ...
      if(!jQuery('body').hasClass('left-side-collapsed')) {
         if(sub.is(':visible')) {
            sub.slideUp(200, function(){
               ...
               parent.find('li').removeClass('nav-active');//去除内部的nav-active
               jQuery(this).find('ul').slideUp(200);//关闭内部ul
            ...
            parent.siblings().removeClass('nav-active');//去除兄弟级的nav-active
            parent.siblings().find('li').removeClass('nav-active');//去除兄弟级的nav-active
            parent.siblings().find('ul').slideUp(200);//关闭兄弟级下的所有ul
