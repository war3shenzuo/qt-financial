...
<div class="row">
	<div class="col-md-12">
		...
		<section class="panel">
			...
			<div class="panel-body">
				<p>备注：</p>
				<p>1、上门随访得分计算：每个病人上门随访的完成情况之和求平均*100；</p>
				<p>2、随访完成情况统计：实际随访次数/应该随访的次数；</p>
				<p>3、随访最后得分计算：各项得分*权重/（权重之和）*100。</p>
			</div>
		</section>
		<!--notification end-->
	</div>
...
$(document).ready(function() {
	var url = "${pageContext.request.contextPath}/data/visit_frequency_info";
	LoadAjaxData(url, loadVisitFrequencyInfo);
});
function loadVisitFrequencyInfo(data){
	try{
		var htmlStr ="";
