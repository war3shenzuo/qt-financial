...
$(document).ready(function() {
	var url = "${pageContext.request.contextPath}/data/pay_request_ali";
	LoadAjaxData(url, loadPayRequestAli);
});

function loadPayRequestAli(data){
	try{
		var htmlStr ="";
		...
		for(var i=0;i<dataList.length;i++){
			htmlStr += '<tr>'
             		...
             		+  '<td>'+dataList[i].accountTypeDescription+'</td>'
              		...
              		+  '<td><a href="#"  onclick="updateTUserWithdrawRecord('+dataList[i].id+',this,\'WAIT_PAY\')">通过</a></td>'
              		+  '</tr>';
		}
...
function updateTUserWithdrawRecord(id,el,status){
    var $this = $(el);
    $.ajax({
       url:'${pageContext.request.contextPath}/data/updateTUserWithdrawRecord',
       type:'post',
