	...
	<div class="col-md-12">
		...
		<section class="panel">
			<header class="panel-heading">
				<i class="fa fa-list-ol"></i> 团队考核设置项
			</header>
			...
			<div class="panel-body">
				<p>备注：</p>
				<p>1、考核最后得分计算：一级考核项得分*权重/（权重之和）*100；</p>
			</div>
		</section>
		<!--notification end-->
	</div>
...
$(document).ready(function() {
	var url = "${pageContext.request.contextPath}/data/team_assessment_info";
	LoadAjaxData(url,loadTeamAccessment);
});

function loadTeamAccessment(data){
	try{
		var htmlStr ="";
