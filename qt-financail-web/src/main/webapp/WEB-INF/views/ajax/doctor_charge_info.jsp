...
$(document).ready(function() {
	var url = "${pageContext.request.contextPath}/data/doctor_charge_info";
	LoadAjaxData(url, loadDoctorChargeInfo);
});

function loadDoctorChargeInfo(data){
	try{
		var htmlStr ="";
